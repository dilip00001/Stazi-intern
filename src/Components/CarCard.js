...
const CarCard = ({ car }) => {
  return (
    <div key={car.id} className="card-container  shadow-md rounded-lg w-full">
      <img
        src={car.image}
        alt={car.name}
        className="object-cover bg-cover h-60 w-full rounded-xl"
      />
      <div className="cardcontent">
        <div className="flex w-full items-center justify-between my-3.5">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-5">
            <button className="bg-[#93c7fb70] px-2 py-2 rounded-xl ">
